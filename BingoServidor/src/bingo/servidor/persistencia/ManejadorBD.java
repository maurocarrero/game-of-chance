...
public class ManejadorBD implements Serializable, Remote {    
    ...
    public void conectar(String url) throws RemoteException {
        try {
             conexion = DriverManager.getConnection(url);
              ...
              System.out.println("ManejadorBD - Error de conexión.:" + e1.getMessage());
        }
    }
    ...
    public void desconectar() throws RemoteException {
        try {
             conexion.close();
             System.out.println("ManejadorBD - Conexión cerrada correctamente.");
        } catch (SQLException e) {
             System.out.println("ManejadorBD - Error al cerrar la conexión.");
        }
    }
    ...
    public void ejecutar(String sql) throws RemoteException {
        try {
             ...
             System.out.println("ManejadorBD - Error al ejecutar sql.\n" + e.getMessage());
        }
    }
    ...
    public void leer(Persistente b) throws RemoteException {
        try {
            ...
            System.out.println("ManejadorBD - Error al leer objeto.\n" + e.getMessage());
        }
    }
    ...
    public ArrayList obtenerTodos(Persistente b) throws RemoteException {
        ...
        try {
            ...
            System.out.println("ManejadorBD - Error al obtener objetos.\n" + e.getMessage());
        }
        return ret;
    }
